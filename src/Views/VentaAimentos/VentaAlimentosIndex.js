...
const VentaAlimentosIndex = () => {
  return (
    <>
      <Header Titulo={"Todas las ventas"}>
            <Link to="/venta-alimentos"><ButtonAmarillo text={"Regresar"} /></Link>
        </Header>
        ...
        <div className='contenedorBody'>
            ...
            <div className='d-12-button'><Link to="/venta-alimentos/IdVentaInterior">{/*<ButtonCoral text={"Prueba de ID"} />*/}Detalles</Link></div>
        </div>
    </>
  )
}

export default VentaAlimentosIndex